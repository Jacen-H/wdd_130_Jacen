...
➕ Instant Sum Calculations

Automatically calculates totals from multiple dice rolls, making RPG math quick and effortless.

🛠️ Dynamic Dice Builder

Create custom dice with any number of sides—whether it's a standard d6 or a unique d3.

✨ Custom Face Generator (Core Feature)

Define your own values, symbols, or text for each face of a die. This allows you to:

Create "Yes/No" decision dice
